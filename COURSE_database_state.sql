-- ===================================================================
-- SQL Server DML script:   COURSE_database_state.sql
--                    Creates the COURSE database' state
...
--ALTER TABLE dept NOCHECK CONSTRAINT dep_fk_emp; --!!!
--ALTER TABLE emp NOCHECK CONSTRAINT emp_fk_dept; --!!!
